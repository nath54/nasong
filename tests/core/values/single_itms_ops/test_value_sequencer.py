...
"""Auto-generated test stubs for core.values.single_itms_ops.value_sequencer."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.single_itms_ops.value_sequencer
...
class TestSequencer:
    ...
    def test_getitem_torch(self):
        """Test for Sequencer.getitem_torch."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
        device = None
