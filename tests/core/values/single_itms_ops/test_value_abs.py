...
"""Auto-generated test stubs for core.values.single_itms_ops.value_abs."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.single_itms_ops.value_abs
...
class TestAbs:
    ...
    def test_backward(self):
        ...
        # mock_sign = MagicMock(return_value=None)
        # -- Act --
