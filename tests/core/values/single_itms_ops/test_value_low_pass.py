...
"""Auto-generated test stubs for core.values.single_itms_ops.value_low_pass."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.single_itms_ops.value_low_pass
...
class TestLowPass:
    ...
    def setup_method(self):
        ...
        value = None
        max_value = None
        self.instance = core.values.single_itms_ops.value_low_pass.LowPass(value, max_value)

    def test_get_item(self):
        """Test for LowPass.get_item."""
        # -- Setup --
        index = 0
        sample_rate = 0
    ...
    def test_getitem_np(self):
        """Test for LowPass.getitem_np."""
        # -- Setup --
        indexes_buffer = 0.0
        sample_rate = 0
        # mock_minimum = MagicMock(return_value=None)
    ...
    def test_getitem_torch(self):
        """Test for LowPass.getitem_torch."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
        device = ""
