...
"""Auto-generated test stubs for core.values.single_itms_ops.value_time_interval."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.single_itms_ops.value_time_interval
...
class TestTimeInterval:
    ...
    def test_getitem_np(self):
        """Test for TimeInterval.getitem_np."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
    ...
    def test_getitem_torch(self):
        """Test for TimeInterval.getitem_torch."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
        device = None
    ...
    def test_backward(self):
        """Test for TimeInterval.backward."""
        # -- Setup --
        grad_output = None
        context = {}
        sample_rate = 0
