...
"""Auto-generated test stubs for core.values.single_itms_ops.value_mask_treshold."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.single_itms_ops.value_mask_treshold


class TestMaskTreshold:
    """Tests for MaskTreshold."""
    ...
    def test_getitem_np(self):
        """Test for MaskTreshold.getitem_np."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
    ...
    def test_getitem_torch(self):
        """Test for MaskTreshold.getitem_torch."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
        device = None
    ...
    def test_backward(self):
        """Test for MaskTreshold.backward."""
        # -- Setup --
        grad_output = None
        context = {}
        sample_rate = 0
