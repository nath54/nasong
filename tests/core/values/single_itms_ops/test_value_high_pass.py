...
"""Auto-generated test stubs for core.values.single_itms_ops.value_high_pass."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.single_itms_ops.value_high_pass
...
class TestHighPass:
    ...
    def test_getitem_torch(self):
        """Test for HighPass.getitem_torch."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
        device = None
