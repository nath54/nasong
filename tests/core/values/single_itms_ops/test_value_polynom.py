...
"""Auto-generated test stubs for core.values.single_itms_ops.value_polynom."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.single_itms_ops.value_polynom
...
class TestPolynom:
    ...
    def test_getitem_torch(self):
        """Test for Polynom.getitem_torch."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
        device = None
