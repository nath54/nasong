...
"""Auto-generated test stubs for core.values.mult_itms_ops.value_sum."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.mult_itms_ops.value_sum
