...
"""Auto-generated test stubs for core.values.complex.value_distortion."""

import pytest
from unittest.mock import MagicMock, patch
import core.values.complex.value_distortion
...
class TestDistortion:
    ...
    def test_get_item(self):
        ...
        # mock_tanh = MagicMock(return_value=None)
        # -- Act --
    ...
    def test_getitem_np(self):
        """Test for Distortion.getitem_np."""
        # -- Setup --
        indexes_buffer = 0.0
        sample_rate = 0
    ...
    def test_getitem_torch(self):
        """Test for Distortion.getitem_torch."""
        # -- Setup --
        indexes_buffer = None
        sample_rate = 0
        device = ""
